...
export const DEFAULT_CAPABILITIES: CapabilityDescriptor[] = [
  ...
  },
  {
    ...
    requiresApproval: false,
    retryable: false,
    description: 'Create new files safely without overwriting existing ones.',
  },
  {
    ...
    requiresApproval: false,
    retryable: false,
    description: 'Safely delete a file with intent and hash verification.',
  },
  {
    ...
    requiresApproval: false,
    retryable: false,
    description: 'Safely move or rename a file in workspace.',
  },
  {
    ...
    requiresApproval: false,
    retryable: true,
    description: 'Inspect symbol definitions, signatures, and types using Language Service.',
  },
  {
    ...
    requiresApproval: false,
    retryable: true,
    description: 'Find all semantic references to a symbol across the project.',
  },
  {
  ...
  },
  {
    ...
    requiresApproval: false,
    retryable: true,
    description: 'Perform blast radius and impact analysis for changes before mutation.',
  },
