...
pub use checkpoint::{compute_file_sha256_native, compute_string_sha256_native};
pub use patch::{apply_hunk_to_content, levenshtein_distance, string_similarity, RsHunkApplyResult};
pub use runtime::{execute_isolated_command, RsExecutionResult};
pub use search::{search_codebase_native, RsSearchMatch, RsSearchResult};
...
pub fn rs_version() -> String {
    "minus-core 0.1.0 (Rust Native Engine)".to_string()
}
